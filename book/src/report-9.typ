...
#show: report.with(number: 9, name: "Commitment & Pipeline")
...
#figure(
  table(
    ...
    [Requested], [An investor has asked. Nothing is reserved and the founder has
      not answered.], [9],
    [Committed], [The founder accepted. *Still not funded.*], [9],
...
#figure(
  table(
    ...
    [`Investment`], [An intention, and whether the founder accepted it. Exists
      before any money is involved and may never settle.], [9],
    ...
    [`PaymentTransaction`], [What a provider actually did: amount, fee, provider
      name, reference, status. The only evidence of settlement.], [10],
...
#figure(
  ...
  caption: [The one table this report owns. The other three in the chain belong
    to Report 10. *No table in this group stores an aggregate.*],
)
...
transaction — because that is the chain from this report to Report 10. A shortcut
...
after an investor has walked away — Report 10 states the window.

*What this enables.* Report 10 can now assume an approved commitment: a specific
