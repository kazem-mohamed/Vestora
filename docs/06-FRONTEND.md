...
| `/admin/users` | المستخدمون — تعليق/استعادة/حذف (السبب إجباري) |
| `/admin/users/[id]` | **الحساب الواحد وكل المتعلّق بيه**: الحساب · الأمان · المشاريع · العلاقات · المدفوعات · البلاغات · الإجراءات الإدارية |
...
| `/admin/analytics` | قُمع العلاقات · التحوّلات · الوقت في كل مرحلة · الرسوم شهريًا وحسب المشروع — **الأعداد أولًا والنِّسبة ثانوية** |
| `/admin/audit` | سجلّ الإجراءات الإدارية — فلاتر (مشرف · إجراء · مدى تاريخي) وعرض `قبل → بعد` |
